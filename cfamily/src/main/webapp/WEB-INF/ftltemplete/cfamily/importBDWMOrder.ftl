...
<div class="zab_page_default_header_title">导入百度外卖订单</div>
 <div class="btn-group pull-right">
  </div></div>
  <div class="w_h_20 "></div>
<div class="control-group">
	    <div class="controls">
			<a class="btn  btn-success" href="../resources/cfamily/impoort_order_template.xls">下载模板</a>
		</div>
	</div>
...
<script type="text/javascript">
 function importSubmit(addBtn) {
	...
	obj.orderSource = '449715190012';
	obj.orderType = '449715200015';
	obj.orderChannel='449747430005';
	obj.payType='449716200006';
	//zapjs.zw.api_call('com_cmall_familyhas_api_APIBDWMExportOrder',obj,function(result) {
	zapjs.zw.api_call('com_cmall_familyhas_api_orderimport_ApiImportOutOrderByBdwm',obj,function(result) {
			if(result.resultCode==1){
				if(result.resultMessage){
					...
					zapjs.zw.modal_show({
				 	...
				 	parent.zapjs.f.window_close("bdwmOrder");
				}
			}else{
