...
<form class="form-horizontal" method="POST" >
	...
	<div class="control-group">
		<div class="controls">
			<input type="button" class="btn  btn-success" zapweb_attr_operate_id="00404ea71b3111e6a30300505692798f" onclick="editSub(this)" value="提交修改">
	    </div>
	</div>
</form>
<script>
...
zapjs.f.ajaxsubmit(
		...
		switch (o.resultType) {
			...
			parent.zapjs.f.autorefresh();
		 	parent.zapjs.f.window_close("editbdwmOrder");
		});
}
function refresh(){
	parent.zapjs.f.autorefresh();
