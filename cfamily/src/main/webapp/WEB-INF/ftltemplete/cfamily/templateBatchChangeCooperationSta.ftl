...
<div class="control-group">
	    <div class="controls">
			<a class="btn  btn-success" href="../resources/cfamily/batch_change_CooperationSta.xls">下载模板</a>
		</div>
	</div>
...
<div class="control-group">
	...
	<div class="control-group">
    	<div class="controls">
			<input type="button" class="btn  btn-success" zapweb_attr_operate_id="7315af82aebc4317aad3a9a715921c22" onclick="importSubmit()" value="提交新增">
   	</div>
</form>
<script type="text/javascript">
	function closeImportWindow (flg,sId,msg) {
			...
			if(flg == true) {
				zapadmin.model_message('批量结束合作成功');
				zapjs.f.autorefresh();
			} else {
 ...
 function importSubmit() {
	...
	zapjs.zw.api_call('com_cmall_familyhas_api_ApiBatchChangeCooperationSta',obj,function(result) {
		var flg = false;
