...
<#macro m_zapmacro_common_operate_button  e_operate  e_style_css>
	...
	<input type="button" class="${e_style_css}" zapweb_attr_operate_id="${e_operate.getOperateUid()}"  onclick="editMusicTemplete.submit(this);"  value="${e_operate.getOperateName()}" />
</#macro>



<script>
require(['cfamily/js/editMusicTemplete'],function(a){a.init()});
</script>
