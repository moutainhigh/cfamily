		...
		<#list e_pagedata.getPageData() as e_list>
			<tr>
				<#list e_list as e>
		 			<#if (e_index >1)>
		              ...
		              <#else>
				  	  ...
				  	  <#elseif e_index = 13>
				      		<#if e_list[10] == '未冻结'>
				  				<td>
									<input class="btn btn-small" type="button" value="冻结" onclick="zapjs.zw.func_tip(this,'${e_list[0]}','冻结') " zapweb_attr_operate_id="f1dc57b69f7e42358073391d40309aff">
								</td>
				  			<#elseif e_list[10] == '冻结'>
				  				<td>
									<input class="btn btn-small" type="button" value="解冻" onclick="zapjs.zw.func_tip(this,'${e_list[0]}','解冻') " zapweb_attr_operate_id="f1dc57b69f7e42358073391d40309aff">
								</td>
				  			</#if>
				  	  <#elseif e_index = 5>
				  	  		<td>
		  		...
		  		<#if e_list[10] == '冻结'>
		  		<#assign resultObj = b_method.upDataOne("za_userinfo","flag_enable","","user_name=:user_name","user_name","${e_list[1]}")>
		  				<#if resultObj.flag_enable=='2'>
		  				   <td style="color:red">
		  					 终止合作
						   </td>
						   <td>
						   <input class="btn btn-small" type="button" value="开启合作" onclick="zapjs.zw.func_tip(this,'${e_list[0]}','开启合作') " zapweb_attr_operate_id="f1dc57b69f7e42358073391d40309fbi">
						   </td>
						<#else>
						   <td>
		  					合作中
						   ...
						   <td>
						   <input class="btn btn-small" type="button" value="结束合作" onclick="zapjs.zw.func_tip(this,'${e_list[0]}','结束合作') " zapweb_attr_operate_id="f1dc57b69f7e42358073391d40309fbi">
						   </td>
						</#if>
						
		  			<#elseif e_list[10] == '未冻结'>
		  				<td>
