...
<div class="zab_info_page_title  w_clear">
<span>栏目内容列表</span><a  class="btn btn-small" href="page_add_v_fh_apphome_channel_movie?zw_f_channel_uid=${RequestParameters['zw_f_uid']}" style="height:20px;margin-left:10px">新增栏目内容</a>
<a  class="btn btn-small" href="javascript:deleteAll()" style="height:20px;margin-left:10px">批量删除</a>
</div>
<#assign channelDetails=b_method.upControlPage("page_chart_v_fh_apphome_channel_movie","zw_f_channel_uid=" + channel_uid + "&" + "zw_p_size=-1").upChartData()>
