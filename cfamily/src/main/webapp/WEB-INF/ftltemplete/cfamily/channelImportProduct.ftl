...
<div class="w_h_20 "></div>
	...
	<div class="control-group">
	    <div class="controls">
			<a class="btn  btn-success" href="../resources/cfamily/channelProduct.xls">下载模板</a>
		</div>
	</div>
...
<script type="text/javascript">
 function importSubmit() {
	...
	zapjs.zw.api_call('com_cmall_productcenter_service_ApiChannelImportProduct',obj,function(result) {
		zapjs.zw.modal_show({
