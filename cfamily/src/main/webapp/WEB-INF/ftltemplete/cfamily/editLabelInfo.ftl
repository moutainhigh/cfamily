...
<script>
    $(function(){
        ...
        if($("#zw_f_label_position").val()=='449748430001'){
        ...
        }else if($("#zw_f_label_position").val()=='449748430005'){
        	$("#div_zw_f_list_pic").before('<span id="descrip" style="float:left;margin-left:370px; position: absolute;line-height:32px;">通栏下尺寸（建议）：710*100</span>');
        }else{
        	$("#div_zw_f_list_pic").before('<span id="descrip" style="float:left;margin-left:370px; position: absolute;line-height:32px;">尺寸（建议）：69*69</span>');
        }
