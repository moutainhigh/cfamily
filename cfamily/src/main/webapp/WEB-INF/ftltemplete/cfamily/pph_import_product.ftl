...
<div class="control-group">
	    <div class="controls">
			<a class="btn  btn-success" href="../resources/cfamily/ppth_product_import.xls">下载模板</a>
		</div>
	</div>
...
<script type="text/javascript">
 function importSubmit() {
	...
	zapjs.zw.api_call('com_cmall_familyhas_api_ApiPPTHProductImport',obj,function(result) {
