...
<#assign productMap=b_method.upDataOneOutNull("pc_productinfo","","","","product_code",productCode)> 
...
<form class="form-horizontal" method="POST" >
	...
	<div class="control-group">
		<label class="control-label" for="">仅支持在线支付:</label>
		<div class="controls">
			<div class="control_book">
				<#if productMap['onlinepay_flag'] == '449747110002'>
					是
				<#else>
					否
				</#if>
	...
	<div class="control-group">
		<label class="control-label" for="">生效时间:</label>
		<div class="controls">
			<div class="control_book">
				<#if productMap['onlinepay_start'] != '' && productMap['onlinepay_end'] != '' >
				${productMap['onlinepay_start']} 至  ${productMap['onlinepay_end']}
				</#if>
 			</div>
		</div>
	</div>			
