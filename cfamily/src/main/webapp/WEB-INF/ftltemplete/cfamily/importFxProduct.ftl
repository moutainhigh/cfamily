...
<div class="control-group">
	    <div class="controls">
			<a class="btn  btn-success" href="../resources/cfamily/product_Import_fx.xls">下载模板</a>
		</div>
	</div>

<#assign eventCode = b_page.getReqMap()["zw_f_event_code"] >
<#assign doType = b_page.getReqMap()["zw_f_do_type"] >
...
<div class="control-group">
	...
	<div class="controls">
			<input type="hidden" id="zw_f_event_code" name="zw_f_event_code" value="${eventCode}">
...
function up_urlparam(key,sUrl) {
 ...
 function importSubmit() {
	...
	obj.event_code=$('#zw_f_event_code').val();
	obj.do_type='${doType}';
	zapjs.zw.api_call('com_cmall_familyhas_api_ApiImportFxProduct',obj,function(result) {
