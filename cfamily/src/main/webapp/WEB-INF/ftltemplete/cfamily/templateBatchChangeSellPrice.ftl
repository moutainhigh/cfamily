...
<div class="control-group">
	    <div class="controls">
			<a class="btn  btn-success" href="../resources/cfamily/batch_change_sellPrice.xls">下载模板</a>
		</div>
	</div>
...
<script type="text/javascript">
	function closeImportWindow (flg,sId,msg) {
			...
			if(flg == true) {
				zapadmin.model_message('批量修改售价成功');
				zapjs.f.autorefresh();
			} else {
 ...
 function importSubmit() {
	...
	zapjs.zw.api_call('com_cmall_familyhas_api_ApiBatchChangeSellPriceImport',obj,function(result) {
		var flg = false;
