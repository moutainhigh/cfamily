...
<form class="form-horizontal" method="POST" >
	...
	<#-- 添加快捷回复选项 -->
	<#assign selectCommentRelList = b_method.upControlPage("page_chart_v_fh_dlq_comment_rel","zw_p_sql_where=flg='1000'&zw_p_size=-1").upChartData()>
	<div class="control-group">
		<label class="control-label">快捷回复内容：</label>
		<div class="controls">
			<select id="select_dlq_comment_rel">
	...
	<script type="text/javascript">
		$("#select_dlq_comment_rel").change(function(){
