...
<form class="form-horizontal" method="POST" > 
	...
	<div class="control-group">
    	<div class="controls">
		<input type="button" class="btn  btn-success" zapweb_attr_operate_id="d09c8fb5d92511e9abac005056165069" id="btnShowProductCount" onclick="xuanpinAdd.onClickProductCount()"  value="查询商品数量" />
...
<input type="hidden" id="${e_field.getPageFieldName()}" name="${e_field.getPageFieldName()}" value="${e_field.getPageFieldValue()}">
<div class="controls">
    <input class="btn" type="button" value="选择分类" onclick="xuanpinAdd.showChooseCategoryBox()">
...
<input type="hidden" id="${e_field.getPageFieldName()}" name="${e_field.getPageFieldName()}" value="${e_field.getPageFieldValue()}">
<div class="controls">
    <input class="btn" type="button" value="选择品牌" onclick="xuanpinAdd.showChooseBrandBox()">
...
<script>
require(['cfamily/js/xuanpinAdd'],function(a){a.init()});
</script>