...
<script type="text/javascript">
 function importSubmit(addBtn) {
	...
	obj.orderSource = '4497151900140001';
	obj.orderType = '4497152000180001';
	obj.orderChannel='4497474300060002';
	obj.payType='4497162000070001';
	//zapjs.zw.api_call('com_cmall_familyhas_api_ApiImportOrder',obj,function(result) {
			...
			if(result.resultCode==1){
				if(result.resultMessage){
					...
					zapjs.zw.modal_show({
				 	...
				 	parent.zapjs.f.window_close("importDSBSCOrder");
				}
			}else{
