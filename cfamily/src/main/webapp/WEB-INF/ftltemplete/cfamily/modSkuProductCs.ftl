...
<#assign skuDetail=b_method.upControlPage("page_chart_v_cf_modSku_pc_skuinfo_cshop","zw_f_product_code=" + e_list["product_code"] + "&" + "zw_p_index=0" + "&" + "zw_p_size=10").upChartData()>
