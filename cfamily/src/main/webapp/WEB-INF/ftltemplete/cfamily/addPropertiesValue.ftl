...
<form class="form-horizontal" method="POST" >
	<#-- 属性编号 -->
	<#assign properties_code = b_page.getReqMap()["properties_code"]?default("") >
...
<#macro m_zapmacro_common_auto_list e_pagedata   e_page>
	<input id="properties_code" type="hidden" value="${properties_code}"  name="properties_code">
...
<#macro m_zapmacro_common_auto_field e_field   e_page>
		...
		<#elseif  e_field.getFieldTypeAid()=="104005022">
	  	...
	  	<#elseif  e_field.getFieldTypeAid()=="104005019">
	  		<#if e_field.getPageFieldName() == 'zw_f_event_type_code'>
