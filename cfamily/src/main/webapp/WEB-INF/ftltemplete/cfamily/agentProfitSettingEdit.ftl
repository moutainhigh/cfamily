...
<script>	
	$(function(){
		var rate1 = $("#zw_f_coupon_rate").val()*100;
		var rate2 = $("#zw_f_agent_rate").val()*100;
		var rate3 = $("#zw_f_fans_rate").val()*100;
		var rate4 = parseInt($("#zw_f_company_rate").val()*100);
		$("#zw_f_coupon_rate").val(rate1);
		$("#zw_f_agent_rate").val(rate2);
		$("#zw_f_fans_rate").val(rate3);
		$("#zw_f_company_rate").val(rate4);
