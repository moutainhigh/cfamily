			...
			<tr>
	  		 <#list e_list as e>			
	      		...
	      		<#elseif e_index ==3>
	      			...
	      			<td>
		      	 		${e?default("")}
		      	 		<input type="hidden" id="zw_f_cost_price_old_${e_list_index}" name="zw_f_cost_price_old"  value="${e_list[3]}">
		      	 	</td>
		      	 	
		      	 	<td>
		      	 		<input type="text" id="zw_f_cost_price_${e_list_index}" name="zw_f_cost_price" zapweb_attr_regex_id="469923180007" onkeyup="cfamily_modproduct.checkNum(this)  value="">
		      	 	</td>
		      	 ...
		      	 <#elseif e_index ==4>
	      			...
	      			<td>
		      	 		${e?default("")}
		      	 		<input type="hidden" id="zw_f_sell_price_old_${e_list_index}" name="zw_f_sell_price_old"  value="${e_list[4]}"">
		      	 	</td>
		      	 	
		      	 	<td>
		      	 		<input type="text" id="zw_f_sell_price_${e_list_index}" name="zw_f_sell_price" zapweb_attr_regex_id="469923180007" onkeyup="cfamily_modproduct.checkNum(this) value="">
		      	 	</td>
	 		...
	 		<tr>
	      		<td colspan='5'style='text-align:center;'>
	      			<input type="button" value="提交修改" onclick="productSkuPrice.submit(this)" zapweb_attr_operate_id="afbaab08c803416fa607e38f7457ce12" class="btn  btn-success">
	      		</td>
	      	</tr>
		</tbody>
</table>
