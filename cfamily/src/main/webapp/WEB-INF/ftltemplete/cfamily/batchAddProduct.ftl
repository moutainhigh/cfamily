...
<div class="control-group">
	    <div class="controls">
			<a class="btn  btn-success" href="../resources/cfamily/batchAddProduct.xls">下载模板</a>
		</div>
	</div>
...
<script type="text/javascript">
 function importSubmit() {
	...
	zapjs.zw.api_call('com_cmall_familyhas_api_ApiBatchAddAppletPayProd',obj,function(result) {
		zapjs.zw.modal_show({
			content : result.resultMessage,
			okfunc : 'zapjs.f.tourl("page_chart_v_v_pc_applet_pay_success");'
		});
	});			
