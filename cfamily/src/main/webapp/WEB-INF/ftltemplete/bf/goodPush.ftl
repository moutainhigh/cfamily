		...
		<thead>
		    <tr>
		        <#list e_pagedata.getPageHead() as e_list>
        			...
        			<#if e_list_index != 9&&e_list_index!=10>
        				<th>
							${e_list}
						</th>
        			</#if>
				...
				<#assign skuStatus=e_list[8]>
		  		 <#list e_list as e>
					...
					<#elseif e_index==8>
						...
						<td>
							<#if skuStatus=='已下架'>
								<input zapweb_attr_operate_id="0745f98cbc9b4c6b8171b7d0da3695c5" class="btn btn-small" onclick="good_push(this, '${skuCode}')" type="button" value="上架">
							<#elseif skuStatus=='已上架'>
								<input zapweb_attr_operate_id="17330edf53424b26b761b1e059c6116a" class="btn btn-small" onclick="good_under(this, '${skuCode}')" type="button" value="下架">
							</#if>
						</td>
					<#elseif e_index==9||e_index==10>
...
<script type="text/javascript" src="../resources/bf/goodPush.js"></script>