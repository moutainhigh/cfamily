...
<@ss_common_head/>
<script type="text/javascript" src="${ss_assign_resources}js/productdetail.js"></script>
...
<div class="bottom"><span <@ss_common_page_click "productdetail.tostIsCall()"/>>电话订购</span><a id="buy_select_info_id" <@ss_common_page_click "productdetail.buySelectInfo()"/> unable="false">立即购买</a></div>
<div id="mask">&nbsp;</div>
<div class="tabw">
            ...
            <div class="pop">				
				<div class="pop-c" id="kinds_product_properties_id">
					...
					<div class="sel selnum">
						...
						<div class="bnum fr">
							<form><a  class="btn-minus">减一</a><input type="text" value="1" onkeyup="value=this.value.replace(/[^\d]/g,'')" maxlength="2" id="buy-num"/><a class="btn-add">加一</a></form>
							<span id="showSkuMaxBuy"></span>
						</div>
					</div>
				</div>
			</div>
	...
	<footer><a class="btn-buy" <@ss_common_page_click "productdetail.submitProductInfo()"/>>立即购买</a></footer>  
