...
<style type="text/css">
	...
	.xq-pro1-first .pic{display: block;margin:0 auto;padding-left: 2%;overflow:hidden;}
        .pic h3{font-size: 1.1em; line-height: 20px;color:#313332;margin:10px 0px;display: -webkit-box!important;-webkit-line-clamp: 2;-webkit-box-orient: vertical;overflow: hidden!important; }
        .pic p{line-height: 17px;font-size: 0.9em;color:#666666;}
        .pic h4{font-size: 0.9em; margin-top: 20px;margin-bottom: 10px;}
        .pic b{ font-weight: normal;color:#DC0F50;display:block; float: left;width: 50%;}
...
<!-- 
   <div class="xq-pro">
        <a href="#"><img  class="lazy" src="zzz_js/bg.png" data-original="images/xptj_3.jpg" alt="完美甄选，新品抢先"  /></a>
    </div>


 <div class="xq-pro1">
        <a><img  class="lazy" src="zzz_js/bg.png" data-original="images/20140826_cuxiao2.jpg" alt="超柔藤席提花5件组促销"  onClick="sendCommand('goods_num:132129')"/></a>
       
		<div class="pic" onClick="sendCommand('goods_num:132129')">
    		<h3>D&Hhu皇冠</h3>
			<p>如所购产品发生退货，需将赠品一并退回，如未退回将按赠品售价收取相应费用</p>
			<h4><b>现价：￥<span>999.00</span></b><strong>市场价:<del>￥1498.00</del></strong></h4>
		</div>
    ...
    <div class="xq-pro1">
        <a><img  class="lazy" src="zzz_js/bg.png" data-original="images/116279-1.jpg" alt="韩国原装进口惠人原汁机HU-500"  onClick="sendCommand('goods_num:116279')"/></a>
        <a><img  class="lazy" src="zzz_js/bg.png" data-original="images/116279-2.jpg" alt="韩国原装进口惠人原汁机HU-500"  onClick="sendCommand('goods_num:116279')"/></a>
    </div>
...
<script type="text/javascript">
	...
	var syurl="/cfamily/jsonapi/com_cmall_familyhas_api_ApiForNewProducts?api_key=betafamilyhas&activity=467703130008000100040001&buyerType="+up_urlparam('buyerType','');
	(function() {
		  $.ajax({
		 		type:"GET",
		 		url:syurl,
		 						...
		 						if(data.banner_img.length > 0){
		 							if(data.banner_link.length >0){
										...
										var r = data.banner_link.match(reg);
		 								if(null != r) {
		 									divStr += "<div class=\"xq-pro\"><a href=\"#\" onclick=\"sendCommand('"+data.banner_link+"')\"><img  class=\"delay\" src=\"../../resources/cfamily/zzz_js/xptj_bg.png\" data-original="+data.banner_img+" alt=\""+data.banner_name+"\"/></a></div><div class=\"wrap\">";
		 								} else {
			 								divStr += "<div class=\"xq-pro\"><a href=\""+data.banner_link+"\"><img  class=\"delay\" src=\"../../resources/cfamily/zzz_js/xptj_bg.png\" data-original="+data.banner_img+" alt=\""+data.banner_name+"\"/></a></div><div class=\"wrap\">";
		 								}
		 							} else {
		 								divStr += "<div class=\"xq-pro\"><a href=\"#\"><img  class=\"delay\" src=\"../../resources/cfamily/zzz_js/xptj_bg.png\" data-original="+data.banner_img+" alt=\""+data.banner_name+"\"/></a></div><div class=\"wrap\">";
		 							}
		 						}
		 						...
		 						for(var j=0;j<items.length;j++){
									...
									var list_price=items[j].list_price;
									 ...
									 divStr += "<div class=\"xq-pro1\">"
										+"<a><img  class=\"delay\" src=\"../../resources/cfamily/zzz_js/xptj_bg.png\" data-original=\""+img_url+"\" alt=\""+item_name+"\"  onClick=\"sendCommand('goods_num:"+goods_num+"')\"/></a>"
