...
<div class="w_left zw_page_tree_left">
	...
	<@m_common_html_script "require(['cmanage/js/flowStatusChange'],function(a){cmanage.flowStatusChange.init('flowStatusChangeId');});" />
	<input type="hidden" value="" id="selectDefineValueId">
	<a class="btn btn-small"  onclick="cmanage.flowStatusChange.add('flowStatusChangeId')">添加流程配置</a>
