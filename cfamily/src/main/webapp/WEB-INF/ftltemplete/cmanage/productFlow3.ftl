...
<table  class="table  table-condensed table-striped table-bordered table-hover">
	<thead>
	    <tr>
    		<th><input id="chb-item-all" type="checkbox" onclick=$('input[id^="chb-item-"]').prop('checked',$(this).prop('checked'))>全选</th>
   ...
   <tbody>
		<#list e_pagedata.getPageData() as e_list>
			<tr>
			<td>
				<input id="chb-item-${e_list[0]}" type="checkbox" value="${e_list[0]}" onclick="$('#chb-item-all').prop('checked',false)" data-productcode="${e_list[3]}">
			</td>
...
<script type="text/template" id="flow_form_forsubmit_temp">
	...
	<input type="hidden" id="zw_f_to_status" name="zw_f_to_status" value="4497172300160001">
	<input type="hidden" id="zw_f_flow_code" name="zw_f_flow_code" value="#zw_f_flow_code#">
	<input type="hidden" id="zw_f_current_status" name="zw_f_current_status" value="4497172300160015">
	...
	<div class="control-group">
		<div class="controls">
			<div class="btn-toolbar">
				<input id="flow_form_btn_submit" type="button" style="margin-right:5px;" class="btn  btn-primary" zapweb_attr_operate_id="115793e80b38485aaba8223e0ea101b7" zap_tostatus_attr="4497172300160001" value="同意" onclick="zapjs.zw.func_call(this)">
			</div>
		</div>
	</div>
	</form>	
