...
if (typeof define === "function" && define.amd) {
	define("cmanage/js/flashsales",["zapjs/zapjs",'zs/zs',"zapjs/zapjs.zw","zapadmin/js/zapadmin_single"],function() {
		return flashsales;
	});
}
