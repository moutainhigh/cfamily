...
function openApp(sendTp) {
	...
	/*5.3.4 安卓手机调用短信原生方法 开始*/
	if(browser1.versions.ios || browser1.versions.iPhone || browser1.versions.iPad){
		...
		try {
					if (ua.indexOf("MicroMessenger") > 0 || ua.match(/MicroMessenger/i) == "micromessenger") {
						...
						window.location.href = "huijiayou://huijiayou.com?ichsy_key=3&ichsy_value=1";
						setTimeout(function () {
							if (ua.indexOf("MicroMessenger") > 0 || ua.match(/MicroMessenger/i) == "micromessenger") {
								window.location.href = "https://a.app.qq.com/o/simple.jsp?pkgname=com.jiayou.qianheshengyun.app&g_f=991850";
							}
	...
	(function() {
		...
		try{
			if(sendTp == 1) {//商品详情页，获取商品编号
			    ...
			    window.location.replace("https://a.app.qq.com/o/simple.jsp?pkgname=com.jiayou.qianheshengyun.app&g_f=991850");
...
//					$("#open_app_ifr").attr("src","https://appsto.re/cn/iR2qM.i");
		...
		try {
			...
			var downloadAction = {};
			downloadAction.appName = "com.jiayou.qianheshengyun.app";
			downloadAction.url = "https://a.app.qq.com/o/simple.jsp?pkgname=com.jiayou.qianheshengyun.app&g_f=991850";
			var actionStr = JSON.stringify(downloadAction);
			window.injs.downloadApp(actionStr);
			//alert('完毕')
		} catch (e) { 
		//alert('window.injs.downloadApp__Error：'+e)
		//window.location = url; 
...
function hasApp(url) {  
    ...
    curnt1 = setTimeout(function () {  
    	if (!hasApp) {
//    		clearTimeout(curnt2);
//        	window.location = "https://a.app.qq.com/o/simple.jsp?pkgname=com.jiayou.qianheshengyun.app&g_f=991850";
        }  
