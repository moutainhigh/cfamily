...
var act_jyh = {
    "smg": [
        { "start": "2018/05/05 10:00:00", "end": "2018/05/07 00:00:00", "gourl": "/index.html", "showtitle": "APP购物更便捷，直播品下单最高享8折！", "imgurl": "https://test-wx.huijiayou.cn/img/tu_app_end.png" },
    ],
}*/
...
var g_const_columnType = {
    ...
    /*秒杀*/
    "SecKill": "4497471600010022",
    /*拼团*/
    "GroupBuy": "4497471600010023",
	
	/*5.5.6一栏多行*/
    "Recommend1LDH": "4497471600010025",
};
/*‘显示更多’链接类型*/
...
/*支付宝支付地址*/
var g_Alipay_url = "https://api-family.syapi.ichsy.com/cfamily/payOrder/";
/*惠家有webpay支付地址*/
var g_HJYWebPay_url = "https://small-family.huijiayou.cn/cfamily/webPay/";
/*惠家有灰度webpay支付地址
var g_HJYWebPay_url = "http://api-family-hd.huijiayou.cn/cfamily/webPay/";*/
...
var g_const_PageURL = {
	...
	"Feedback_Index534": "/Feedback/Index.html",
    /*5.3.4 客服与帮助 列表*/
    "Feedback_List": "/Feedback/List.html",
    /*5.3.4 客服与帮助 问答页*/
    "Feedback_Detail": "/Feedback/Detail.html",
	/*5.3.4 商户营业执照展示页*/
    "MerchantInfo": "/Product_Merchant.html",
	/*5.4.0 拼团规则页*/
    "GroupExplain": "/GroupExplain.html",
    /*5.4.0 拼团邀请页*/
    "GroupInvite": "/GroupInvite.html",
    /*5.4.0 拼团详情页（支持sku选择）*/
    "GroupDetail": "/Account/GroupDetail.html",
    /*5.4.0 储值卡兑换页*/
    "CZJExchange": "/Act/jycard/czk.html",
};
/*接口提示信息集合 1 接口返回  9-接口返回错误 8-系统返回错误 7-页面提示错误*/
var g_const_API_Message = {
    "1": "操作成功",
    "934105101": "您还没有注册哦，请注册后再登录",
    "934105102": "密码过于简单，请重置密码",
    "8801": "验证码错误",
...
var g_const_SMG_DateList = [["2017-3-10 13:00:00", "2017-3-15 19:00:00", "微信购物更便捷 直播品下单立享85折！", "/smg_v3/index.html"]];

var g_const_OrderConfirmRefer = ["product_detail", "cart", "preorderconfirm", "mobilechz_order", "myorder_list", "myorder_detail", "login", "login_m", "login_m", "orderfail","smg"];
...
/*商户活动链接域名*/
var g_merchant_Act_Host = window.location.protocol+"//image-mall.huijiayou.cn";
//活动类型
...
//用于跨域调用客服系统中Js的页面
/*var g_const_kf_kv = "https://kf.huijiayou.cn/CPS_KF/kv.html";*/
var g_const_kf_kv = "https://localhost:11587/CPS_KF/kv.html";
...
//网站域名
var g_const_domain = window.location.protocol + "//test-wx.huijiayou.cn/";
...
/*5.3.4 客服与帮助类型
    ...
    "yhq": "优惠券",
*/
var g_const_FeedbackType = {
    "a449748260001": { "title": "物流问题", "pic": "/img/feedback/shwt_04.jpg" },
    "a449748260002": { "title": "售后问题", "pic": "/img/feedback/shwt_07.jpg" },
    "a449748260003": { "title": "订单问题", "pic": "/img/feedback/shwt_09.jpg" },
    "a449748260004": { "title": "支付问题", "pic": "/img/feedback/shwt_11.jpg" },
    "a449748260006": { "title": "账号问题", "pic": "/img/feedback/shwt_07_03.jpg" },
    "a449748260005": { "title": "优惠券问题", "pic": "/img/feedback/shwt_10.png" },
};
