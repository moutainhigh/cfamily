var cfamily_modproduct = {
	...
	// 初始化
	init_chartProductinfoCshop : function(p) {
...
//		zapweb_upload.upload_file('zw_f_editor',cfamily_modproduct.product.description.descriptionInfo);
		...
		$('#zw_f_qualification_category_code').val(cfamily_modproduct.product.qualificationCategoryCode);//资质品类
...
//				}
				...
				$('#cfamily_addproduct_custom table tbody').append(
						'<tr><td><input class="c_text" disabled="disabled" value="' + cfamily_modproduct.product.pcProductpropertyList[props]['propertyKey']
						+ '"/></td><td><textarea rows="2" class="c_value" disabled="disabled" value="' + cfamily_modproduct.product.pcProductpropertyList[props]['propertyValue']
						+ '">' + cfamily_modproduct.product.pcProductpropertyList[props]['propertyValue']+ '</textarea></td><td></td></tr>');
				$('#cfamily_addproduct_custom_text').val('');
				$('#cfamily_addproduct_custom_value').val('');
				continue;
...
if (typeof define === "function" && define.amd) {
	define("cfamily/js/chartProductinfoCshop", [ "zapweb/js/zapweb_upload","zapweb/js/zapweb_upload_modify",
