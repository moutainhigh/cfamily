var editMusicTemplete = {
	init : function(){
		$("#zw_f_template_id").attr("disabled",true);
		$("#zw_f_template_type_id").attr("disabled",true);
	...
	submit:function(obj){
		 ...
		 */
		var validatResult = editMusicTemplete.validateImageSize();
...
if (typeof define === "function" && define.amd) {
	define("cfamily/js/editMusicTemplete", function() {
		return editMusicTemplete;
	});
}