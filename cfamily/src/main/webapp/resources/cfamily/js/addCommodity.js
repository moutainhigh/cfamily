var addCommodity = {
	init : function(t_type){
		...
		// 取上次缓存的开始和结束时间
		var startTime = $.cookie(zapjs.c.cookie_base + "template-start-time");
		var endTime = $.cookie(zapjs.c.cookie_base + "template-end-time");
		...
		if(t_type == "449747500007" ){//   优惠券(一行两栏) 
			//隐藏
			addCommodity.hideEle("event_code,commodity_picture,is_dis,commodity_name,commodity_describe,good_number,commodity_number,skip,skip_input,url,width,template_desc,img,city_name,live_mobile,title_checked_color,preferential_desc,title,title_color,describes,describe_color,sub_template_number");
			$("#linkvalueDiv").hide();
			$("#selectPcCtrol").hide();
			
			//显示
			addCommodity.showEle("template_number,programa_picture,commodity_location,coupon");
			
		}else if(t_type == "449747500008"){//  优惠券（一行一栏   更改为 一行多栏）
			//隐藏
			addCommodity.hideEle("event_code,commodity_picture,is_dis,commodity_name,commodity_describe,good_number,commodity_number,skip,skip_input,url,template_desc,img,city_name,live_mobile,title_checked_color,preferential_desc,title,title_color,describes,describe_color,sub_template_number");
			$("#linkvalueDiv").hide();
			$("#selectPcCtrol").hide();
			
			//显示
			addCommodity.showEle("template_number,programa_picture,commodity_location,coupon,width");
			
		}else if(t_type == "449747500009"){//普通视频模板
			//显示
			addCommodity.showEle("template_number,commodity_location,url,good_number,start_time,end_time,template_desc");
			//隐藏
			addCommodity.hideEle("event_code,commodity_number,commodity_picture,is_dis,commodity_name,commodity_describe,skip,skip_input,create_time,dal_status,coupon,width,programa_picture,img,city_name,live_mobile,title_checked_color,preferential_desc,title,title_color,describes,describe_color,sub_template_number");
			$("#linkvalueDiv").hide();
			
		}else if(t_type == "449747500010"){//一行多栏（横滑）
			//显示
			addCommodity.showEle("template_number,commodity_location,programa_picture,skip,skip_input,start_time,end_time");
			//隐藏
			addCommodity.hideEle("event_code,url,width,good_number,commodity_number,template_desc,commodity_picture,is_dis,commodity_name,commodity_describe,coupon,create_time,dal_status,img,city_name,live_mobile,title_checked_color,preferential_desc,title,title_color,describes,describe_color,sub_template_number");
			
			zapjs.e('zapjs_e_zapjs_f_ajaxsubmit_submit',addCommodity.beforeSubmit);
			addCommodity.changeType();
		}else if(t_type == "449747500011"){//一行三栏
			//显示
			addCommodity.showEle("template_number,commodity_location,programa_picture,skip,skip_input,start_time,end_time");
			//隐藏
			addCommodity.hideEle("event_code,url,good_number,commodity_number,template_desc,commodity_picture,is_dis,commodity_name,commodity_describe,coupon,create_time,dal_status,width,img,city_name,live_mobile,title_checked_color,preferential_desc,title,title_color,describes,describe_color,sub_template_number");
			
			zapjs.e('zapjs_e_zapjs_f_ajaxsubmit_submit',addCommodity.beforeSubmit);
			addCommodity.changeType();
		}else if(t_type == "449747500012"){//分类模版
			//显示
			addCommodity.showEle("template_number,commodity_location,programa_picture,start_time,end_time,url,img,width");
			//隐藏
			...
			//显示
			addCommodity.showEle("template_number,commodity_location,start_time,end_time,url,city_name,title_color,title_checked_color");
			//隐藏
			addCommodity.hideEle("event_code,good_number,commodity_number,template_desc,commodity_picture,is_dis,commodity_name,commodity_describe,coupon,create_time,dal_status,width,skip,skip_input,img,programa_picture,live_mobile,preferential_desc,title,describes,describe_color,sub_template_number");
			$("#linkvalueDiv").hide();
			$("#selectPcCtrol").hide();
		}else if(t_type == "449747500001" || t_type == "449747500024"){//模版一  或者  悬浮模板
			//隐藏
			addCommodity.hideEle("event_code,commodity_picture,is_dis,commodity_name,commodity_describe,good_number,commodity_number,coupon,url,width,template_desc,img,city_name,live_mobile,title_checked_color,preferential_desc,title,title_color,describes,describe_color,sub_template_number");
			//显示
			addCommodity.showEle("template_number,skip,skip_input,programa_picture,commodity_location");
			
			zapjs.e('zapjs_e_zapjs_f_ajaxsubmit_submit',addCommodity.beforeSubmit);
			addCommodity.changeType();
		}else if(t_type == "449747500023"||t_type == "449747500026"){//556：拼团模板
			//隐藏
			addCommodity.hideEle("start_time,end_time,skip,skip_input,programa_picture,commodity_picture,is_dis,commodity_name,commodity_describe,good_number,commodity_number,coupon,url,width,template_desc,img,city_name,live_mobile,title_checked_color,preferential_desc,title,title_color,describes,describe_color,sub_template_number");
			//显示
			addCommodity.showEle("template_number,commodity_location,event_code");
			
			zapjs.e('zapjs_e_zapjs_f_ajaxsubmit_submit',addCommodity.beforeSubmit);
			addCommodity.changeType();
		} else if(t_type == "449747500006"){//两栏广告
			//隐藏
			addCommodity.hideEle("event_code,commodity_picture,is_dis,commodity_name,commodity_describe,good_number,commodity_number,skip,skip_input,coupon,url,width,template_desc,img,city_name,live_mobile,title_checked_color,preferential_desc,title,title_color,describes,describe_color,sub_template_number");
			//显示
			addCommodity.showEle("template_number,programa_picture,commodity_location");//skip,skip_input,
		...
		}else if(t_type == "449747500015"){	// 右两栏推荐 - Yangcl
			//显示
			addCommodity.showEle("template_number,commodity_location,programa_picture,skip,skip_input,start_time,end_time,title,title_color,describes,describe_color");
			//隐藏
			addCommodity.hideEle("event_code,url,good_number,commodity_number,template_desc,commodity_picture,is_dis,commodity_name,commodity_describe,coupon,create_time,dal_status,img,city_name,width,live_mobile,title_checked_color,preferential_desc,sub_template_number");
			
			zapjs.e('zapjs_e_zapjs_f_ajaxsubmit_submit',addCommodity.beforeSubmit);
			addCommodity.changeType();
		}else if(t_type == "449747500016"){	// 左两栏推荐 - Yangcl
			//显示
			addCommodity.showEle("template_number,commodity_location,programa_picture,skip,skip_input,start_time,end_time,title,title_color,describes,describe_color");
			//隐藏
			addCommodity.hideEle("event_code,url,good_number,commodity_number,template_desc,commodity_picture,is_dis,commodity_name,commodity_describe,coupon,create_time,dal_status,img,city_name,width,live_mobile,title_checked_color,preferential_desc,sub_template_number");
			...
			//隐藏
			addCommodity.hideEle("event_code,commodity_name,good_number,commodity_number,commodity_picture,is_dis,skip,commodity_describe,skip_input,programa_picture,create_time,dal_status,coupon,url,width,template_desc,img,city_name,live_mobile,describes,describe_color,preferential_desc");
			//显示
			/**
			 ...
			 */
			addCommodity.showEle("template_number,commodity_location,sub_template_name,sub_template_number,start_time,end_time,title,title_color,title_checked_color");
			zapjs.e('zapjs_e_zapjs_f_ajaxsubmit_submit',addCommodity.beforeSubmit);
		...
		}else if(t_type == "449747500017"){//扫码购模板
			//显示
			addCommodity.showEle("template_number,commodity_location,good_number,commodity_number,commodity_name,start_time,end_time,commodity_describe,preferential_desc");
			//隐藏
			addCommodity.hideEle("event_code,commodity_picture,is_dis,skip,skip_input,create_time,dal_status,coupon,width,programa_picture,img,city_name,live_mobile,template_desc,url,title,title_color,title_checked_color,describes,describe_color,sub_template_number");
			$("#linkvalueDiv").hide();
			
		} else if(t_type == "449747500020"){//积分兑换模板
			//显示
			addCommodity.showEle("template_number,commodity_location,start_time,end_time,coupon");
			//隐藏
			...
			//隐藏
			addCommodity.hideEle("event_code,programa_picture,is_dis,commodity_describe,commodity_number,coupon,url,width,template_desc,img,city_name,live_mobile,title_checked_color,preferential_desc,title,title_color,describes,describe_color,sub_template_number");
			//显示
			addCommodity.showEle("template_number,skip,commodity_location,commodity_picture,good_number,commodity_name,start_time,end_time");
			
			zapjs.e('zapjs_e_zapjs_f_ajaxsubmit_submit',addCommodity.beforeSubmit);
			addCommodity.changeType();
		} else {//模版二和模版三
			if(t_type == "449747500022"){// 兑换商品模板
				addCommodity.hideEle("event_code,skip,programa_picture,coupon,url,width,template_desc,skip_input,img,city_name,live_mobile,preferential_desc,title,title_color,title_checked_color,describes,describe_color,sub_template_number");
				$("#slId").parent().hide();
				//显示
				addCommodity.showEle("template_number,commodity_number,commodity_picture,commodity_location,is_dis,commodity_name,commodity_describe,good_number");
			}else{
				//隐藏
				addCommodity.hideEle("event_code,commodity_number,skip,programa_picture,coupon,url,width,template_desc,skip_input,img,city_name,live_mobile,preferential_desc,title,title_color,title_checked_color,describes,describe_color,sub_template_number");
				$("#slId").parent().hide();
				//显示
				addCommodity.showEle("template_number,commodity_picture,commodity_location,is_dis,commodity_name,commodity_describe,good_number");
			}			
		}
	},
	...
	changeType : function(){//根据打开方式进行切换  
		...
		if(linktype == "449747550001"){//URL
			//隐藏的项目
			$("#zw_f_live_mobile").parent().parent().hide();
			$("#zw_f_commodity_number").parent().parent().hide();
			$("#zw_f_good_number").parent().parent().hide();
			$("#zw_f_commodity_name").parent().parent().hide();
			$("#selectPcCtrol").hide();
			$("#linkvalueDiv").hide();
			$("#zw_f_showmore_linkvalue_text").hide();//展示分类选项
			//显示
			$("#zw_f_skip_input").parent().parent().show();
...
//				$("#zw_f_commodity_number").parent().parent().show();
			...
			$("#zw_f_good_number").parent().parent().hide();
			$("#zw_f_commodity_name").parent().parent().hide();
			$("#zw_f_commodity_describe").parent().parent().hide();
			$("#zw_f_commodity_picture").parent().parent().hide();
			$("#selectPcCtrol").hide();
			
			$("#zw_f_live_mobile").parent().parent().show();
...
//			document.getElementById("zw_f_skip_input").value="somethind";
//			zapjs.f.message('分类不能为空');
//			return false;
	...
	submit:function(obj){
		...
		} else if(type == "449747500007" ) {//优惠券 一行两栏
			if(backpic==null || backpic==""){
				errMs = "栏目图是必填项";
				flg = true;
			}
			
		} else if( type == "449747500008") {//优惠券 一行多栏
			if(backpic==null || backpic==""){
				errMs = "栏目图是必填项";
				flg = true;
			}
...
//			}
			...
			if(flg == false && (end_time!=null && end_time!="") ) {
				...
				var minute = Math.floor(second / 60);
				    second %= 60;
				if(addCommodity.timeTransfer(day)<=0&&addCommodity.timeTransfer(hour)<=0&&addCommodity.timeTransfer(minute)<=0&&addCommodity.timeTransfer(second)<=0){
					errMs = "目标时间是不能小于当前时间";
					flg = true;
				}
				else if(addCommodity.timeTransfer(day)>99){
		 ...
		 */
		var validatResult = addCommodity.validateImageSize();
		...
		zapjs.f.cookie("template-start-time",start_time,expires);
		zapjs.f.cookie("template-end-time",end_time,expires);
...
if (typeof define === "function" && define.amd) {
	define("cfamily/js/addCommodity", function() {
		return addCommodity;
	});
}
