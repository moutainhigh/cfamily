...
//		$("#zw_f_notice_type").attr("disabled", true);// 通知类型不允许修改
		...
		zapjs.e('zapjs_e_zapjs_f_ajaxsubmit_submit',
				editColumnPc.beforeSubmit);
		editColumnPc.showMoreInit();
		editColumnPc.noticeInit();
...
if (typeof define === "function" && define.amd) {
	define("cfamily/js/editColumnPc", function() {
		return editColumnPc;
	});
}
// 切换是否显示更多时使用
