var addColumnWap = {
	init : function() {
		...
		$("#zw_f_view_type").attr("disabled", true);// 把展示类型设置为WAP页

		zapjs.e('zapjs_e_zapjs_f_ajaxsubmit_submit', addColumnWap.beforeSubmit);
...
if (typeof define === "function" && define.amd) {
	define("cfamily/js/addColumnWap", function() {
		return addColumnWap;
	});
}
// 切换是否显示更多时使用
