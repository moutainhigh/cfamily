...
//		});
		if(up == 1){
			...
			$("#zw_f_settlement_type").prop("disabled",true);
			$("#zw_f_volumn_length").prop("disabled",true);
			$("#zw_f_volumn_width").prop("disabled",true);
			$("#zw_f_volumn_high").prop("disabled",true);
			$("input[zapweb_attr_operate_id='0f530993c7d14e8ebfce88e2c0f03ac5']").hide();
			$("input[zapweb_attr_operate_id='e0214e6994794e1d9fe51eb820294aea']").hide();
			setTimeout(function(){
				CKEDITOR.instances["zw_f_editor"].setReadOnly(true);
			},500);
		}else{
			$("input[zapweb_attr_operate_id='5e013e8a157f47edbcdbf00007596c9e']").hide();
		}
...
if (typeof define === "function" && define.amd) {
	define("cfamily/js/modproductKjt", [ "zapweb/js/zapweb_upload","zapweb/js/zapweb_upload_modify",
