...
var category_tree = {
	...
	tree_init : function(oElm) {
		...
		opt = {};
		opt.seller_code = 'SI2003';
		zapjs.zw.api_call('com_cmall_productcenter_process_SellerCategoryApi',opt,function(result) {
	...
	tree_selectCategroy : function() {
		...
		if(id!=''&&id.trim().length==20){
			$("#zw_f_category_codes").val(id).triggerHandler('onCategoryChange');
			$("#xlNameId").text(caname);
...
if (typeof define === "function" && define.amd) {
	define("cfamily/js/categorySelectEditNewProduct",function() {
