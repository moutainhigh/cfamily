...
/**
 * 
 * 类: ImportBDWMOrderEdit <br>
 * 描述: 添加修改按钮事件：百度外卖导入订单收款状态修改操作函数 <br>
 * 作者: 张海宇 zhanghaiyu@huijiayou.cn<br>
 * 时间: 2016年8月12日 上午9:50:07
 */
public class ImportBDWMOrderEdit extends RootFunc {
	...
	public MWebResult funcDo(String sOperateUid, MDataMap mDataMap) {
		 ...
		 * 修改百度订单表的收款状态
		 */
		int result = DbUp.upTable("oc_orderinfo_bdwm").dataUpdate(editMap, "", "uid");
		if (result >= 0) {
			/*
			 * 将订单金额导入到惠家有订单表中的已付款金额中
			 */
			MDataMap bdwmOrderMap = DbUp.upTable("oc_orderinfo_bdwm")
