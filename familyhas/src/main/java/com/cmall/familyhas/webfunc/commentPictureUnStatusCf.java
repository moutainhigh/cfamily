...
public class commentPictureUnStatusCf extends RootFunc{
	...
	public MWebResult funcDo(String sOperateUid, MDataMap mDataMap) {
		...
		if(CommentCodeCf.pictureRefuse.equals(isDisable)){
			mResult.setResultCode(934205104);
			mResult.setResultMessage("状态已为图片拒绝！");
		}else{
			dataMap.put("pic_status", CommentCodeCf.pictureRefuse	);
