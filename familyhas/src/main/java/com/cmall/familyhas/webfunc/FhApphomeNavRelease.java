...
/**
 * @description: 发布导航信息|TODO 此处是否需要考虑到缓存化的问题？？？？？？？？
 *
 * @author Yangcl
 * @date 2017年5月3日 下午2:10:33 
 * @version 1.0.0
 */
public class FhApphomeNavRelease extends RootFunc {
	...
	public MWebResult funcDo(String sOperateUid, MDataMap mDataMap) {
		...
		if(StringUtils.isNotBlank(uid) && StringUtils.isNotBlank(releaseFlag)){
			...
			String sql = "select c.* from familyhas.`fh_apphome_column` c left join familyhas.`fh_apphome_nav` n on n.nav_code = c.nav_code "
					+ "where "
					//+ "c.view_type='4497471600100001' "
					+ "c.view_type in ('4497471600100001','4497471600100002','4497471600100004','4497471600100005') "
