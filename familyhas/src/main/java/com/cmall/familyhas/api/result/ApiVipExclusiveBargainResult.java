...
public class ApiVipExclusiveBargainResult extends RootResult {
	
	@ZapcomApi(value="总数据数")
	private int totalPage;
	@ZapcomApi(value="列表数据")
	private List<VipBargain> itemList;
	...
	public List<VipBargain> getItemList() {
		return itemList;
	}
	public void setItemList(List<VipBargain> itemList) {
