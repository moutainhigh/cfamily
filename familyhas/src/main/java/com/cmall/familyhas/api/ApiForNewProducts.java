...
import com.cmall.familyhas.api.input.ApiForNewProductsInput;
import com.cmall.familyhas.api.model.NewProducts;
import com.cmall.familyhas.api.result.ApiForNewProductsResult;
 ...
 *
 */
public class ApiForNewProducts extends RootApiForMember<ApiForNewProductsResult,ApiForNewProductsInput>{

	
	public ApiForNewProductsResult Process(ApiForNewProductsInput inputParam,
			MDataMap mRequestMap) {
		ApiForNewProductsResult result = new ApiForNewProductsResult();
		...
		if(result.upFlagTrue()){
            ...
            MDataMap mDataMap = new MDataMap("info_category", activity,"manageCode",getManageCode());
