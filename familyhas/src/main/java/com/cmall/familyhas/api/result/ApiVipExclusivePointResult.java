...
public class ApiVipExclusivePointResult extends RootResult {
	
	@ZapcomApi(value="总数据数")
	private int totalPage;
	@ZapcomApi(value="列表数据")
	private List<VipAreaPoint> itemList;
	...
	public List<VipAreaPoint> getItemList() {
		return itemList;
	}
	public void setItemList(List<VipAreaPoint> itemList) {
