...
public class JobForWhetherUpdateFourthCategory extends RootJob{

	
	@Override
	public void doExecute(JobExecutionContext context) {
		//从redis获取是否需要更新数据库标记
		String string = XmasKv.upFactory(EKvSchema.IsUpdateCategoryProductCount).get("isUpdateCateProd");
		if("update".equals(string)) {
			...
			XmasKv.upFactory(EKvSchema.IsUpdateCategoryProductCount).set("isUpdateCateProd","no");
		}
	}
